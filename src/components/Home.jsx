      ...
      <div className="flex flex-col gap-y-5 items-start">
        <div className="w-full flex flex-row gap-x-4 justify-between items-center">
          <input
            ...
            className={`${
              pasteId ? "w-[80%]" : "w-[85%]"
            } text-black border border-input border-gray-300 outline-0 rounded-md p-2 `}
          />
          <button
            className="text-white bg-blue-400 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
            onClick={createPaste}
          >
        ...
        >
          ...
          <textarea
            ...
            className="w-full p-3  focus-visible:ring-0 outline-0"
            style={{
              caretColor: "#000",
            }}
            rows={20}
